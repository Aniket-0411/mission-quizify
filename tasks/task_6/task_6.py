...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        chroma_creater = ChromaCollectionCreator(processor,embed_client)
        ####### YOUR CODE HERE #######
        ...
        with st.form("Load Data to Chroma"):
            ...
            quiz_topic = st.text_input("Enter the topic for quiz",placeholder="Please enter topic")
            # 4) for the quiz topic and the desired number of questions
            no_of_questions = st.slider("Number of Questions", min_value=1, max_value=10, value=1)
            ####### YOUR CODE HERE #######
            ...
            if submitted:
                ...
                ####### YOUR CODE HERE #######
                chroma_creater.create_chroma_collection()    
                # Uncomment the following lines to test the query_chroma_collection() method
                document = chroma_creater.query_chroma_collection(quiz_topic) 
